...
const curatedEntries: SearchEntry[] = [
  ...
  { id: "product:territorial-agendas", title: "Problemas y oportunidades por departamento del Perú", description: "Explorador de 25 agendas territoriales con problemas públicos, poblaciones afectadas, decisiones y oportunidades por validar.", href: "/dataperu/agendas-territoriales", kind: "product", label: "Agendas territoriales", topic: "gobierno", featured: true, keywords: ["problemas por región", "problemas por departamento", "agenda territorial", "población afectada", "oportunidades regionales", "agua", "empleo", "seguridad", "agricultura", "turismo", "minería", "gobierno regional", "municipalidad", "Perú"] },
  { id: "product:water-sanitation", title: "Agua y saneamiento por distrito en Perú", description: "Explorador de cobertura de agua y servicio higiénico por red pública para 1,892 distritos con resultados oficiales de los Censos Nacionales 2025.", href: "/dataperu/agua-saneamiento", kind: "product", label: "Datos territoriales", topic: "gobierno", featured: true, keywords: ["agua por red pública", "saneamiento", "servicio higiénico", "desagüe", "brecha de agua", "censo 2025", "INEI", "distrito", "municipalidad", "viviendas", "Perú"] },
  { id: "product:education", title: "Matrícula escolar por distrito en Perú", description: "Explorador de matrícula EBR, nivel, ámbito, gestión y procedencia del dato para 1,892 distritos con información oficial del Minedu 2025.", href: "/dataperu/educacion", kind: "product", label: "Datos territoriales", topic: "gobierno", featured: true, keywords: ["educación", "matrícula escolar", "matrícula EBR", "educación básica regular", "Minedu", "Censo Educativo", "inicial", "primaria", "secundaria", "educación rural", "UGEL", "DRE", "distrito", "municipalidad", "Perú"] },
  ...
  { id: "guide:urban-cadastre-data", title: "Análisis de catastro, desarrollo urbano y territorio", description: "Guía para integrar catastro municipal, crecimiento urbano, suelo, zonificación, servicios, riesgos e inversiones con evidencia geoespacial.", href: "/analisis-catastro-desarrollo-urbano-territorial", kind: "solution", label: "Guía urbana y territorial", topic: "gobierno", featured: true, keywords: ["catastro municipal", "catastro urbano", "catastro multifinalitario", "desarrollo urbano", "planificación urbana", "ordenamiento territorial", "acondicionamiento territorial", "PDU", "PDM", "PAT", "zonificación", "uso de suelo", "suelo urbano", "expansión urbana", "vivienda", "SIG", "geoespacial", "municipalidad", "gobierno regional", "TDR"] },
  ...
  { id: "guide:territorial-education-data", title: "Análisis de datos para educación territorial", description: "Guía para diagnosticar acceso, asistencia, trayectorias, aprendizajes, condiciones del servicio e intervenciones educativas.", href: "/analisis-datos-educacion-territorial", kind: "solution", label: "Guía sectorial", topic: "gobierno", featured: true, keywords: ["educación", "educación territorial", "aprendizaje", "matrícula", "asistencia", "abandono escolar", "trayectoria educativa", "ESCALE", "Censo Educativo", "ENLA", "UMC", "UGEL", "DRE", "GRE", "infraestructura educativa", "conectividad", "brechas educativas", "evaluación educativa", "gobierno regional", "municipalidad", "TDR"] },
  { id: "guide:public-investment-data", title: "Análisis de inversión pública, presupuesto y proyectos", description: "Guía para priorizar y seguir carteras con avance financiero, físico, contractual, riesgos, hitos y preparación operativa.", href: "/analisis-inversion-publica-proyectos", kind: "solution", label: "Guía sectorial", topic: "gobierno", featured: true, keywords: ["inversión pública", "proyectos de inversión", "obras públicas", "cartera de proyectos", "ejecución presupuestal", "PIA", "PIM", "devengado", "avance físico", "Invierte.pe", "SSI", "SIAF", "SEACE", "InfObras", "OPMI", "UEI", "UF", "restricciones", "municipalidad", "gobierno regional", "TDR"] },
  { id: "guide:public-procurement-data", title: "Análisis de contrataciones públicas y proveedores", description: "Guía para analizar demanda, procedimientos, competencia, proveedores, plazos, contratos y oportunidades del mercado público.", href: "/analisis-contrataciones-publicas-proveedores", kind: "solution", label: "Guía de compras públicas", topic: "gobierno", featured: true, keywords: ["contrataciones públicas", "compras públicas", "proveedores del Estado", "mercado público", "SEACE", "OECE", "OSCE", "RNP", "Perú Compras", "procedimientos de selección", "estudio de mercado", "competencia", "concurrencia", "ejecución contractual", "oportunidades de negocio", "abastecimiento", "municipalidad", "gobierno regional", "empresa", "TDR"] },
  { id: "evidence:samples", title: "Muestras de entregables", description: "Nueve arquitecturas de entregables para examinar cómo NOAM estructura un encargo.", href: "/muestras", kind: "evidence", label: "Muestras", topic: "gobierno", keywords: ["informe", "dashboard", "entregable", "ejemplo", "diagnóstico de servicio público", "desempeño de servicios"] },
