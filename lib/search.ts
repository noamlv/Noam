...
const curatedEntries: SearchEntry[] = [
  ...
  { id: "evidence:samples", title: "Muestras de entregables", description: "Siete arquitecturas de entregables para examinar cómo NOAM estructura un encargo.", href: "/muestras", kind: "evidence", label: "Muestras", topic: "gobierno", keywords: ["informe", "dashboard", "entregable", "ejemplo"] },
