import { ArrowRight, BriefcaseBusiness, Check, Database, Droplets, FileChartColumn, GraduationCap, Layers3, MapPinned, Radar, Search, ShieldAlert } from "lucide-react";
...
import { educationSummary } from "@/lib/dataperu-education";
...
const modules = [
  ...
  { icon: GraduationCap, title: "Educación", description: `Matrícula EBR, nivel, ámbito y gestión en ${formatMetric(educationSummary.districts)} distritos según el Minedu.`, href: "/dataperu/educacion", status: "Disponible" },
...
const coverageRoadmap = [
  ...
  { title: "Servicios y bienestar", state: "Dos capas disponibles", description: "Agua y saneamiento con Censos 2025, y matrícula EBR distrital con información oficial del Minedu 2025. Salud continúa en evaluación de fuentes." },
          ...
          <div className="grid gap-10 lg:grid-cols-[0.55fr_1fr] lg:gap-20">
            ...
            <div className="divide-y divide-border border-y border-border">
              {[
                ...
                { title: "Matrícula escolar por distrito", label: "Disponible", href: "/dataperu/educacion", text: "Matrícula EBR, nivel, ámbito, gestión y procedencia del dato para 1,892 distritos." },
